...
!!! warning
    ...
    (i.e. the code that constructs [`LLM`](https://docs.vllm.ai/en/v0.26.0/api/vllm/#vllm.LLM) class).
...
!!! note
    ...
    The random state in user code (i.e. the code that constructs [`LLM`](https://docs.vllm.ai/en/v0.26.0/api/vllm/#vllm.LLM) class) is updated by vLLM 
