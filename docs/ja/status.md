...
全 226 ページ中 **225 ページ**を翻訳済みです（99.6%）。
...
- `deployment/k8s.md`
- `deployment/nginx.md`
- `design/arch_overview.md`
- `design/attention_backends.md`
...
- `models/pooling_models/embed.md`
- `models/pooling_models/reward.md`
- `models/pooling_models/scoring.md`
- `models/pooling_models/specific_models.md`
...
- `serving/expert_parallel_deployment.md`
